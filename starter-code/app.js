...
IMPORTANT DETAIL: You may not use the arithmetic operators + and * in this function. To do addition, use your sum() function, and to do multiplication, use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to us e the + operator for string concatenation.
...
var string = `${testArray[0]}, ${testArray[1]}. ${testArray[2]} was passed in as an array of numbers, and 9 was thier sum.` 
sumArray(testArray);
}
